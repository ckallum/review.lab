...
- [ ] **T1.6 — Hash + revision-diff test suite (`hunks.test.ts`).** 30+ property cases on the hash function. 10+ fixture cases for revision diffing (hunk-add, hunk-remove, file-rename, ordering changes). Must pass before T1.7 merges.
