...
5. **FR-P0.5 — Confidence display stub.** All hunks render at `confidence=high` in week 1. UI bands are low/medium/high with red/amber/green. `hunks.confidence` column exists in schema so swapping values later is one line.
